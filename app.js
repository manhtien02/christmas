...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi Ngố!";
    let charArrTitle = textTitle.split('');
let text = "Ngố iu của a à dolor sit amet consectetur adipisicing elit. Minus architecto beatae corporis veritatis dolorum tenetur pariatur illum excepturi quaerat. Voluptate harum suscipit, ea consequuntur voluptatem quam error eligendi beatae vero?"
